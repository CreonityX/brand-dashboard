...
export function DashboardWidgetShell({
    ...
    return (
        <div className={cn(
            "group relative border border-zinc-800 bg-zinc-900/40 backdrop-blur-md overflow-hidden flex flex-col transition-all duration-300 ease-out hover:border-zinc-700 hover:bg-zinc-900/60 hover:z-10",
