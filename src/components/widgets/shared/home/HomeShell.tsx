...
function SidebarContent() {
    ...
    return (
        <>
            <DashboardWidgetShell title="Budget" icon={Wallet} className="min-h-0">
                <div className="p-4 space-y-3">
                    ...
                    <div className="h-1.5 bg-zinc-800 rounded-[1px] overflow-hidden">
                        <div className="h-full bg-[#a3e635] rounded-[1px]" style={{ width: `${pct}%` }} />
                    </div>
            ...
            <DashboardWidgetShell title="Alerts" icon={Bell} className="min-h-0">
                <div className="p-4">
